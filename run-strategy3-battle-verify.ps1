...
node scripts\verify-strategy3-battle-state.js 2>&1 | Tee-Object -FilePath $log -Append
if ($LASTEXITCODE -ne 0) {
  throw "Strategy3 battle verify failed with exit code $LASTEXITCODE; log=$log"
}
