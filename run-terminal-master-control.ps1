...
$checkpointContracts = [ordered]@{
  ...
  "06:05" = @{ name="source_startup_guard"; verifiers=@("verify-daytrade-fugle-source-startup.js","verify-daytrade-writer-checkpoint-health.js"); hardGate="writer_v2_transport_channels_today_cache_isolation" }
  ...
  "08:00" = @{ name="opening_report_external_owner"; owner="EXTERNAL_OWNER"; disposition="SKIPPED_BY_THIS_CONTROLLER"; verifiers=@(); hardGate="read_external_handoff_only_no_recalculation_or_retry" }
  "08:20" = @{ name="opening_report_external_owner"; owner="EXTERNAL_OWNER"; disposition="SKIPPED_BY_THIS_CONTROLLER"; verifiers=@(); hardGate="read_external_handoff_only_no_recalculation_or_retry" }
  "08:29" = @{ name="opening_report_external_owner"; owner="EXTERNAL_OWNER"; disposition="SKIPPED_BY_THIS_CONTROLLER"; verifiers=@(); hardGate="read_external_handoff_only_no_recalculation_or_retry" }
  "08:30" = @{ name="opening_report_external_owner"; owner="EXTERNAL_OWNER"; disposition="SKIPPED_BY_THIS_CONTROLLER"; verifiers=@(); hardGate="read_external_handoff_only_no_recalculation_or_retry" }
  ...
  "08:36" = @{ name="opening_report_external_owner"; owner="EXTERNAL_OWNER"; disposition="SKIPPED_BY_THIS_CONTROLLER"; verifiers=@(); hardGate="read_external_handoff_only_no_recalculation_or_retry" }
  "08:45" = @{ name="preopen_master_gate"; verifiers=@("verify-daytrade-source-contract-alignment.js","verify-daytrade-mother-pool-contract.js"); hardGate="transport_pool_trial_formal_isolation" }
  "09:00" = @{ name="intraday_operation"; verifiers=@("verify-daytrade-writer-checkpoint-health.js","verify-daytrade-intraday-burst-telegram.js"); hardGate="mother_pool_freshness_event_only_telegram" }
  "12:30" = @{ name="strategy2_finalize_and_strategy3_readiness"; verifiers=@("verify-strategy2-v3-live-closure.js","verify-strategy3-v2-readiness-guard-contract.js","verify-strategy3-v2-water-universe.js"); hardGate="single_canonical_run_finalize_and_v2_readiness" }
  ...
  "13:15" = @{ name="strategy3_closure"; verifiers=@("verify-strategy3-v2-full-closure.js"); hardGate="supabase_api_surfaces_telegram_88" }
  "13:30" = @{ name="postclose_transition"; verifiers=@("verify-daytrade-source-contract-alignment.js"); hardGate="postclose_fail_closed_transition" }
  ...
  "17:00" = @{ name="strategy4_closure"; verifiers=@("verify-strategy4-postscan-closure.js"); hardGate="desktop_mobile_88_original_run" }
  ...
  "21:40" = @{ name="evening_four_surface"; verifiers=@("verify-strategy5-e2e-closure.js","verify-institution-e2e-closure.js","verify-institution-battle-state.js"); hardGate="strategy5_institution_battle_surfaces_88" }
...
# A queued trigger may start after its nominal minute. Always service the earliest due
# checkpoint that has not produced a receipt today, rather than guessing from wall time.
$processedCheckpointIds = @()
if (-not $RequestedCheckpoint) {
  ...
  $processedCheckpointIds = @($processedCheckpointIds | Sort-Object -Unique)
  if ($effectiveMode -eq "Checkpoint") {
    $earliestUnprocessedDue = @($checkpointContracts.Keys | Where-Object {
      [TimeSpan]::Parse($_) -le $startedAt.TimeOfDay -and $processedCheckpointIds -notcontains $_
    } | Sort-Object { [TimeSpan]::Parse($_) } | Select-Object -First 1)
    if ($earliestUnprocessedDue.Count -gt 0) { $checkpointId = [string]$earliestUnprocessedDue[0] }
  }
}
...
try {
  ...
  $waitSpecs = switch ($checkpointId) {
    ...
    "13:15" { @(@{ task="Fuman Strategy3 V2 Complete Scan 1300"; timeout=600 }) }
    "17:00" { @(@{ task="Fuman Strategy4 Cache 1600"; timeout=900 }) }
  ...
  $strategy2VerifierDue = @("12:30", "12:40", "23:10") -contains $checkpointId
  ...
  foreach ($checkpointVerifier in @($checkpointContract.verifiers)) {
    ...
    & node --use-system-ca $checkpointVerifierPath @checkpointVerifierArgs
  ...
  $coveredCheckpointIds = @($processedCheckpointIds + $currentCoverageCheckpoint | Where-Object { $_ } | Sort-Object -Unique)
  ...
  $requiredCompletionWaitCheckpoints = @("12:30", "13:15", "17:00", "21:40")
  $originalTaskWaitFailure = ($requiredCompletionWaitCheckpoints -contains $checkpointId) -and (@($originalTaskWait | Where-Object { $_.completed -ne $true }).Count -gt 0)
  ...
  $firstBlocker = if ($originalTaskWaitFailure) { "original_task_natural_completion_timeout" }
    ...
    elseif ($checkpointVerifierFailure) { "checkpoint_specific_verifier_blocked" }
  ...
  if ($strategy2VerifierDue -and (Test-Path -LiteralPath $strategy2VerifierReceipt)) {
    try {
