...
const checks = [
  ...
  ["api_canonicalizes_formal_quality", api.includes('qualityStatus: replay ? "diagnostic_replay" : "complete"') && api.includes('evidenceStatus: replay ? "diagnostic_replay" : "complete"') && api.includes("run_quality_at_publish:")],
