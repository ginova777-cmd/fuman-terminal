...
const REQUIRED_IN_ROOT = [
  ...
  "scorecard:candidate:export",
  "verify:terminal-canary-publish:live",
  "verify:terminal-canary-publish:candidate",
...
function verifyRootOrder(rootScripts, issues) {
  ...
  const orderedPairs = [
    ...
    ["rollforward:terminal", "scorecard:terminal-source"],
    ["scorecard:terminal-source", "scorecard:candidate:export"],
    ["scorecard:candidate:export", "verify:terminal-canary-publish:live"],
    ["verify:terminal-canary-publish:live", "verify:terminal-canary-publish:candidate"],
    ["verify:terminal-canary-publish:candidate", "verify:terminal-resource-chain:unattended"],
