...
async function main() {
  ...
  for (const marker of [
    'const VERSION = "public-terminal-fast-', "function dailyKlineHtml(row)", "function klineSvg(rows)",
