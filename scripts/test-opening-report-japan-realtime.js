...
function fixture(symbol="4062.T",change={}) {
 const board={codeWithMarketExtension:symbol,price:{value:"1,010"},priceChangeRate:{value:"1.00"},japanUpdateTime:"09:50:00",delayMinutes:0,ptsPrice:"2000",ptsPriceChangeRate:"100",ptsUpdateTime:"23:55",...change};
...
const date="2026-09-14",at="2026-09-14T00:50:10.000Z";
...
for(const change of [{japanUpdateTime:"9/14"},{japanUpdateTime:"09:51:00"},{japanUpdateTime:"08:59:59"},{japanUpdateTime:"09:01:00"},{japanUpdateTime:"25:10:00"},{delayMinutes:20},{delayMinutes:null},{priceChangeRate:{value:""}},{priceChangeRate:{value:"2.00"}},{price:{value:null}},{codeWithMarketExtension:"5803.T"}]) assert.equal(parseQuote(fixture("4062.T",change),"4062.T",date,at).ok,false,JSON.stringify(change));
for(const capture of ["2026-09-14T00:51:00Z","2026-09-15T00:50:10Z","2026-09-14T00:19:00Z"]) assert.equal(parseQuote(fixture(),"4062.T",date,capture).ok,false);
...
assert.equal(parseQuote(fixture("4062.T",{japanUpdateTime:"09:50:59"}),"4062.T",date,"2026-09-14T00:50:59.999Z").ok,true);
(async()=>{
 ...
 try {
   ...
   Date.now=()=>Date.parse("2026-09-14T00:51:00Z");
