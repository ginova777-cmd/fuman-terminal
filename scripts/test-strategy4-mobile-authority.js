...
function valid() {
 ...
 const g={contract:GATE_CONTRACT,ok:true,kdK:70,kdD:60,kdPrevK:60,kdPrevD:55,rsi6:60,rsi6Prev:55,rsi3:70,rsi3Prev:65,kdTrendUp:true,rsiTrendUp:true,kdGoldenCross:false,rsiGoldenCross:false};
...
test('independent complete run does not inherit intraday preserve label',()=>assert.equal(strategy4MobileAuthority({...valid(),preservePreviousGood:true},day).preservePreviousGood,false));
