...
function staticChecks() {
  ...
  return {
    ...
    bullishGainVolumeRule: writer.includes("change_percent>2 AND ma5>ma10>ma20 AND volume_expanding"),
    ...
    motherPoolDynamicRange: writer.includes("const MOTHER_POOL_TARGET_MIN_SYMBOLS = 300;") && writer.includes("const MOTHER_POOL_MAX_SYMBOLS = Math.max(") && writer.includes("Math.min(600,") && writer.includes("mother_pool_scan_max_symbols"),
