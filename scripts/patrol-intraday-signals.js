...
const MARKET_START_MINUTES = Number(process.env.STRATEGY2_SCAN_START_MINUTES || (8 * 60 + 45));
const MARKET_END_MINUTES = Number(process.env.STRATEGY2_SCAN_END_MINUTES || (13 * 60 + 30));
