...
function selfTest() {
  const cases = [
    ...
    { name: "blocked_preserve", input: { strategy: "x", status: "blocked", complete: false, exitCode: 0, fallback: false, blockingReason: "source not_ready" }, expect: { status: "blocked_preserved", complete: false, qualityStatus: "preserved_latest", publishAllowed: false, preservePreviousGood: true, unattendedStatus: "NO" } },
    { name: "fallback_blocks", input: { strategy: "x", status: "complete", complete: true, exitCode: 0, fallback: true, runId: "x-20260721-1" }, expect: { status: "blocked_preserved", complete: false, qualityStatus: "preserved_latest", publishAllowed: false, preservePreviousGood: true, fallback: true } },
    { name: "complete_but_preserve_warning_blocks", input: { strategy: "x", status: "complete", complete: true, exitCode: 0, fallback: false, runId: "x-20260721-1", warnings: ["blockedReceipt=r.json"], blockingReason: "preserve previous good" }, expect: { status: "blocked_preserved", complete: false, qualityStatus: "preserved_latest", publishAllowed: false, preservePreviousGood: true, evidenceStatus: "insufficient", unattendedStatus: "NO" } },
    { name: "stale_runid_date_blocks", input: { strategy: "x", status: "complete", complete: true, exitCode: 0, fallback: false, runId: "x-20260727-1", startedAt: "2026-07-31T08:00:04.000+08:00", matches: 29 }, expect: { status: "blocked_preserved", complete: false, qualityStatus: "preserved_latest", publishAllowed: false, preservePreviousGood: true, evidenceStatus: "insufficient", unattendedStatus: "NO" } },
  ];
  const issues = [];
