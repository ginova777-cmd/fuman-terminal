...
function main() {
  ...
  need(all(verifier0855, ["expectedRunId", "runIdReadback", "run_id_missing_all_receipts", "expected_run_id_mismatch"]), failures, "verifier0855_run_id_contract_drifted");
  need(all(closedLoop, ["taskLastResult", "task_0840_last_result_not_zero", "task_0900_last_result_not_zero", "verifier_0900_late_repair_not_scheduled_pass", "run_id_missing_all_runtime_receipts"]), failures, "closed_loop_scheduled_run_id_contract_drifted");
