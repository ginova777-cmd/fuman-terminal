...
function verifyRetirement(root=path.resolve(__dirname,'..')) {
 ...
 if(!current.includes("runRendered(run,scan)")||!current.includes('strategy4_runner_verifier_receipt_v2'))throw Error('strategy4_rendered_gate_removed');
 return {ok:true,contract:'strategy4_runner_verifier_receipt_v2',retired:'finalize-strategy4-receipt.js',canonical:'verify-strategy4-complete.js'};
}
