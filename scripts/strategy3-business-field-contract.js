...
const FIELD_SPECS = [
  ...
  ["latestCandleTime", "intraday_1m_readiness_at_run.latest_candle_time", "scannerOutput.sourceCoverage.latest_candle_time", "api.intraday_1m_readiness_at_run.latest_candle_time", "run.payload.intraday_1m_readiness_at_run.latest_candle_time", "v_strategy3_intraday_1m_status", "1 分 K 最新時間", "non-empty timestamp"],
  ["intraday_1m_stale_seconds", "intraday_1m_readiness_at_run.stale_seconds", "scannerOutput.sourceCoverage.intraday_1m_stale_seconds", "api.intraday_1m_readiness_at_run.stale_seconds", "run.payload.intraday_1m_readiness_at_run.stale_seconds", "v_strategy3_intraday_1m_status", "1 分 K stale gate", "number <= max_stale_seconds"],
  ["today_1m_symbols", "intraday_1m_readiness_at_run.today_1m_symbols", "scannerOutput.sourceCoverage.today_1m_symbols", "api.intraday_1m_readiness_at_run.today_1m_symbols", "run.payload.intraday_1m_readiness_at_run.today_1m_symbols", "v_strategy3_intraday_1m_status", "1 分 K 覆蓋率", "number > 0"],
  ...
  ["ready_ge_35", "intraday_1m_readiness_at_run.ready_ge_35", "scannerOutput.sourceCoverage.ready_ge_35", "api.intraday_1m_readiness_at_run.ready_ge_35", "run.payload.intraday_1m_readiness_at_run.ready_ge_35", "v_strategy3_intraday_1m_status", "MA35 readiness", "number > 0"],
  ["ready_ge_80", "intraday_1m_readiness_at_run.ready_ge_80", "scannerOutput.sourceCoverage.ready_ge_80", "api.intraday_1m_readiness_at_run.ready_ge_80", "run.payload.intraday_1m_readiness_at_run.ready_ge_80", "v_strategy3_intraday_1m_status", "長樣本 readiness", "number > 0"],
  ...
  ["ma20", "matches[].ma20", "scannerOutput.matches[].ma20", "api.matches[].ma20", "result.payload.ma20", "strategy3_ready_snapshot/v_strategy3_intraday_1m_status", "MA20 技術條件", "number > 0"],
  ["ma35", "matches[].ma35", "scannerOutput.matches[].ma35", "api.matches[].ma35", "result.payload.ma35", "strategy3_ready_snapshot/v_strategy3_intraday_1m_status", "MA35 技術條件", "number > 0"],
...
const STRATEGY3_DECISION_GATE_MATRIX = [
  ...
  ["intraday_1m_ready", "intraday_1m_readiness_at_run.status", "scannerOutput.sourceCoverage.today_1m_symbols", "api.intraday_1m_readiness_at_run.status", "run.payload.intraday_1m_readiness_at_run.status", "v_strategy3_intraday_1m_status", "1m/MA readiness 決定策略3能否形成正式進場", true, true, true, "ready/ok", "stale/failed/low_rows", "intraday 1m not ready", false, "", true, true, "today_1m_symbols and ready_ge_35 >= threshold, stale <= 120", "stale-1m-publish-allowed", "FAIL"],
...
const STRATEGY3_SOURCE_CONTRACT_MATRIX = [
  ...
  ["intraday_1m_readiness_at_run", "intraday_1m_readiness_at_run", "v_strategy3_intraday_1m_status", true, true, true, "ready_ge_35 coverage >= 0.95", 120, "", "ready_ge_35 and today_1m_symbols sufficient", "stale-1m", true],
  ["intraday_1m_stale_seconds", "intraday_1m_readiness_at_run.stale_seconds", "v_strategy3_intraday_1m_status", true, true, true, "<= 120 live or after-session final candle policy", 120, "", "stale_seconds <= max_stale_seconds", "stale-1m", true],
  ["ma_readiness_at_run", "ma_readiness_at_run", "v_strategy3_intraday_1m_status", true, true, true, "MA20/MA35 coverage >= 0.95", 120, "", "ready_ma20 and ready_ma35 sufficient", "ma-insufficient", true],
  ["ready_ma20", "ma_readiness_at_run.ready_ma20_continuous", "v_strategy3_intraday_1m_status", true, true, true, ">= 95% expected symbols", 120, "", "ready_ma20_continuous >= threshold", "ma20-low", true],
  ["ready_ma35", "ma_readiness_at_run.ready_ma35_continuous", "v_strategy3_intraday_1m_status", true, true, true, ">= 95% expected symbols", 120, "", "ready_ma35_continuous >= threshold", "ma35-low", true],
  ...
  return {
    ...
    sourceDriftHealth: {
      ...
      checks: [
        ...
        { source: "v_strategy3_intraday_1m_status", status: "ready", rowCount: 1500, minRequired: 1000 },
    ...
    matches: ["1609", "2014"].map((code, index) => ({
      ...
      dataContractSource: "fugle_quotes_latest+v_strategy3_intraday_1m_status+stock_daily_volume",
      source: "strategy3_scan_results",
