...
const FILES = [
  ...
  "scripts/run-opening-report-0830-preflight.js",
  "lib/opening-report-japan-realtime.js",
  "lib/opening-report-asia-freshness.js",
  ...
  "scripts/test-opening-report-complete.js",
  ...
  "lib/scorecard-performance-evaluation.js",
  ...
  "scripts/verify-finmind-daily-ohlcv-sync.js",
  "scripts/install-finmind-daily-ohlcv-sync-task.ps1",
  ...
  "install-history-retention-cleanup-task.ps1",
  ...
  "scripts/check-strategy3-direct-mother-pool-readiness.js",
  "scripts/check-strategy3-v2-readiness.js",
  "scripts/run-strategy3-v2-complete-scan.js",
  "scripts/finalize-strategy3-complete.js",
  ...
  "scripts/verify-opening-limit-order-0850-freeze.js",
  ...
  "data/contracts/strategy3_runner_verifier_receipt_v1.json",
  ...
  "scripts/install-strategy3-v2-formal-tasks.ps1",
  "scripts/install-strategy3-v2-readiness-guard-tasks.ps1",
  ...
  "scripts/verify-strategy5-terminal-confluence.js",
  "scripts/verify-strategy5-composite-producers.js",
  "scripts/verify-strategy5-w-bottom-rebound-readonly.js",
  ...
  "scripts/verify-scorecard-performance-evaluation.js",
  ...
  "scripts/run-daytrade-intraday-5m-complete.js",
  "run-daytrade-intraday-5m-complete.ps1",
  "ops/public-slot/DaytradeIntraday5mReadback_20260903.sql",
  ...
  "scripts/e2e-membership-closure-utils.js",
  "scripts/protected-e2e-closure-runner.js",
  ...
  "ops/public-slot/Strategy3V2CleanChainSchema_20260817.sql",
  ...
  "run-finmind-daily-ohlcv-sync.ps1",
