...
const RETIRED_ARTIFACTS = [
  ...
  path.join("data", "heatmap-latest.json"),
  path.join("data", "institution-mobile-top.json"),
  path.join("data", "market-summary.json"),
  path.join("data", "market-ai-breadth-latest.json"),
  path.join("data", "market-ai-panel-latest.json"),
  path.join("data", "market-ai-live.json"),
  path.join("data", "mobile-ai-latest.html"),
  path.join("data", "mobile-ai-lite.html"),
  path.join("data", "mobile-ai-ultra.html"),
  path.join("data", "mobile-home-summary.json"),
  path.join("data", "mobile-stock-analysis-latest.json"),
  path.join("data", "mobile-strategy1-ultra.html"),
  path.join("data", "mobile-strategy2-ultra.html"),
  path.join("data", "mobile-strategy3-ultra.html"),
  path.join("data", "mobile-strategy4-ultra.html"),
  path.join("data", "mobile-strategy5-ultra.html"),
  path.join("data", "mobile-chip-ultra.html"),
  path.join("data", "mobile-warrant-ultra.html"),
  path.join("data", "mobile-digest.json"),
  path.join("data", "terminal-home-bundle.json"),
  path.join("data", "flow-health-latest.json"),
  path.join("data", "health-summary.json"),
  path.join("data", "scan-receipts", "scan-summary.json"),
  path.join("data", "scan-receipts", "strategy2.json"),
  path.join("data", "institution-tdcc-breakout.json"),
  path.join("data", "institution-tdcc-breakout-top.json"),
  path.join("data", "institution-tdcc-breakout.csv"),
  path.join("data", "tdcc-shareholding-1000-history.json"),
  path.join("data", "star-preopen-latest.json"),
  path.join("data", "star-preopen-backup.json"),
  path.join("data", "star-preopen-scorecard-source.json"),
  path.join("data", "mobile-boot.json"),
  path.join("data", "mobile-terminal-latest.json"),
  path.join("data", "terminal-home-mobile-slim.json"),
  path.join("data", "data-manifest.json"),
  path.join("data", "data-status-index.json"),
