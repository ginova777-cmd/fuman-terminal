...
assert(desktopFastShellSource.includes("fuman-market-ai-compact-layout-polish-20260813") && desktopFastShellSource.includes("--fuman-ai-hero-height: 150px") && desktopFastShellSource.includes("#market-view .market-ai-hero-metrics .market-ai-index-chip") && desktopFastShellSource.includes("opening-report-0830-readable-type-20260813") && desktopFastShellSource.includes("font-size: 34px !important") && desktopFastShellSource.includes("market-ai-readable-zh-type-20260813") && desktopFastShellSource.includes("font-size: 22px !important") && desktopFastShellSource.includes("font-size: 18px !important") && desktopFastShellSource.includes("font-size: 15px !important"), "desktop compact market ai layout polish missing");
...
assert(indexSource.includes("compact-layout=20260813-03"), "index cache bust missing compact layout version");
