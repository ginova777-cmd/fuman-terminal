...
async function main() {
  ...
  const payload = {
    ...
    guarantees: [
      ...
      "runner executes preflight, WebSocket source, warmup, rewater, reason classification, formal entry gate, job queue, idempotent scanner contracts, and post-repair Water Root rewater-verification before publish",
