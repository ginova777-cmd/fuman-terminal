...
async function main() {
  ...
  addCheck(checks, details.realtime.displayWindow === "09:00-13:00", "realtime-full-session-window", "即時雷達 full mode must expose 09:00-13:00 displayWindow", details.realtime);
