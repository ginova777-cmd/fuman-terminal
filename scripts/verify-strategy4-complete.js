...
function validate(e,run){
 ...
 const uiIssues=require('../lib/strategy4-rendered-evidence').validateRendered(e.rendered,run,s); fail.push(...uiIssues);
...
function main(){
 require('./verify-strategy4-verifier-retirement').verifyRetirement();
