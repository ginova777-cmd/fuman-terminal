...
const STRATEGIES = [
  ...
  },
  {
    ...
    sourceChain: ["v_strategy3_v2_latest_complete_run", "strategy3_v2_scan_results", "fugle_daytrade_priority_pool", "fugle_daytrade_intraday_1m", "stock_daily_volume"],
    writerRunner: "run-strategy3-v2-complete-scan.ps1 / scripts/run-strategy3-v2-complete-scan.js",
    latestView: "v_strategy3_v2_latest_complete_run",
    runsTable: "strategy3_v2_scan_runs",
    resultsTable: "strategy3_v2_scan_results",
    dailySummaryTable: "strategy_daily_summary",
