...
async function main() {
  ...
  addCheck(checks, page88Local.includes("/api/scorecard?t=") && page88Local.includes("data-source-report-run-id") && page88Local.includes("strategy5"), "page_88_scorecard_strategy5_data_chain_hook", {
