...
function quoteRowsToRadarPayload(rows = [], limit = DEFAULT_RADAR_LIMIT) {
  ...
  return {
    ...
    run_quality_at_publish: {
      ...
      evidenceStatus: "source_quality_fail",
      unattendedStatus: "NO",
      status: "display_only_fallback",
      reason: normalized.length ? "radar cache unavailable/stale; quote view fallback is display-only" : "formal realtime quote view returned no rows",
    },
    transport: {
      source: "supabase",
      table: QUOTE_TABLE,
