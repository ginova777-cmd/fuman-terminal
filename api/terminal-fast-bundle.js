...
function sanitizeStrategy2Endpoints(endpoints = {}) {
  ...
  // Preserve source evidence and runIds exactly; the bundle must never turn fallback/degraded data into unattended success.
  return endpoints;
}

function sanitizeStrategy2BundlePayload(payload, endpoints = {}) {
  void endpoints;
  // Preserve source evidence and runIds exactly.
  return payload;
}
