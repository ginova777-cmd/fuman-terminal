...
function strategy3EntrySourceOk(row = {}) {
  ...
  return source === "intraday_1m_1300";
}
...
function verifyScorecardStrategyRules(payload = {}, options = {}) {
  ...
  addCheck(checks, strategy3BadEntrySource.length === 0, `${source}-strategy3-entry-price-source`, `${source} strategy3 13:00 entry_price must come from intraday_1m_1300, not generic price/latest quote`, { bad: strategy3BadEntrySource });
