...
function matchesAuthoritative(actual, saved) {
 if (!saved || typeof saved !== 'object') return false;
 // Transport provenance is added by forSymbol; it is not calculated volume evidence.
 const {sharedSource, ...evidence} = saved;
 return require('node:util').isDeepStrictEqual(actual, evidence);
}
module.exports={CONTRACT,calculate,valid,tradingDates,forSymbol,matchesAuthoritative};
