...
const STAGES = Object.freeze([
  ...
  { key: "production_project", label: "Production Project Guard", verifier: "scripts/verify-vercel-production-project.js", allowedAction: "run_final_audit_only_from_official_fuman_terminal_release_clone" },
...
function reasonCodeFor(stage, parsed, output = "", fallback = "stage_not_ready") {
  ...
  if (stage === "production_project" && issueCodes.length) return issueCodes[0];
  ...
  const stageDefaults = {
    ...
    production_project: "production_project_not_verified",
