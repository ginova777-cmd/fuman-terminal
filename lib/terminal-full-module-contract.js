...
const DOWNSTREAM_MODULES = Object.freeze([  { key: "power_recovery", label: "Power Outage Recovery", dueTime: "00:00", class: "recovery", source: "state/power-recovery.json", adapter: "power_recovery", command: { cwd: ".", executable: "node", args: ["scripts/verify-terminal-power-recovery.js"] }, verifier: "scripts/verify-terminal-power-recovery.js", allowedAction: "repair_or_register_start_when_available_final_audit_task_then_rerun" },
  ...
  { key: "cb", label: "CB Detect", dueTime: "21:25", class: "chip", source: "data/scan-receipts/cb-detect.json", adapter: "scan_receipt", verifier: "scripts/verify-terminal-resource-chain.js", allowedAction: "rerun_cb_detect_for_current_trade_date_then_reverify" },
  { key: "warrant", label: "Warrant Flow", dueTime: "20:30", class: "chip", source: "data/scan-receipts/warrant-flow.json", adapter: "scan_receipt", verifier: "scripts/verify-terminal-resource-chain.js", allowedAction: "rerun_warrant_flow_for_current_trade_date_then_reverify" },
