...
function buildCoverage(sourceStatusRow = {}) {
  ...
  const motherPoolSymbols = cleanNumber(payload.mother_pool_symbols, cleanNumber(payload.formal_scan_pool_symbols, cleanNumber(payload.active_symbols, cleanNumber(payload.eligible_symbols))));
  ...
  const readyMa20 = cleanNumber(payload.ready_ma20_continuous_symbols, cleanNumber(payload.ready_ma20_continuous));
