...
function buildStatusFromArtifacts(artifacts, source) {
  ...
  return {
    ...
    gates: {
      predictivePreflight: gate(controlPlane.predictivePreflight),
      ...
      canaryPublish: gate(controlPlane.canaryPublish),
...
module.exports = {
  ...
  _private: { buildStatusFromArtifacts, moduleRows, readOutputArtifacts, stableStatus, sameSemanticStatus, compactActionMatrix },
};
