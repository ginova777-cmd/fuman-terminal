...
const DEFINITIONS = [
  ...
  },
  {
    ...
    retryable: true,
    priority: 81,
    test: ({ text }) => /finalaudit_not_ok|final_audit_not_ok|final_audit_issue|terminal_autonomous_completion_audit|completion_audit|ops_status_root_cause_summary|ops_status_root_cause_recovery_plan/.test(text),
  },
  {
