...
const DEFINITIONS = [
  ...
  },
  {
    ...
    retryable: true,
    priority: 83,
    test: ({ text }) => /productionliveopsreadback_not_ok|production_live_not_ok|production_live_issue|production_live_authenticated_readback_required_for_ready|refresh_failed:production_live_readback/.test(text),
  },
  {
