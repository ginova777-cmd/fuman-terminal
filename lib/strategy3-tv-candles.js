...
function qualityReason(quality) {
  return `rows=${quality.rows}; degenerate=${quality.degenerateRows}/${quality.rows}; session=${quality.sessionRows}; entryWindow=${quality.entryWindowRows}; after1300=${quality.after1300Rows}`;
}
