...
const GATE_CONTRACT = "strategy4_daily_kd_rsi_trend_gate_v1";
const NUMBERS = ["kdK", "kdD", "kdPrevK", "kdPrevD", "rsi14", "rsi14Prev", "rsi4", "rsi6"];
...
function dailyTechnicalGateValid(row = {}) {
  ...
  return g.contract === GATE_CONTRACT && g.ok === true && m.dailyTechnicalGateOk === true
    ...
    && g.kdK > g.kdPrevK && g.kdD >= g.kdPrevD && g.rsi14 > g.rsi14Prev;
}
