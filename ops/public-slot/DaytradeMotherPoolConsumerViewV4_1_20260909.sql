...
create index if not exists fugle_daytrade_intraday_1m_symbol_trade_date_time_idx
  on public.fugle_daytrade_intraday_1m (symbol, trade_date, candle_time desc);
