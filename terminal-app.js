...
function getFumanWorker() {
  ...
  try {
    fumanWorker = new Worker("terminal-worker.js?v=strategy4-remove-bc-signal-20260601-08");
...
function loadFumanStyle(href, id) {
  ...
  link.id = id;
  link.rel = "stylesheet";
  link.href = href.includes("?") ? href : `${href}?v=${window.FUMAN_TERMINAL_BOOT?.version || "strategy4-remove-bc-signal-20260601-08"}`;
...
function loadFumanFeatureModule(name, src, globalName) {
  ...
  const version = window.FUMAN_TERMINAL_BOOT?.version || "strategy4-remove-bc-signal-20260601-08";
