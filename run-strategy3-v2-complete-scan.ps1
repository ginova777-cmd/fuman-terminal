...
try {
  ...
  if ($RecoveryReplay) {
    ...
    Invoke-Required "rendered desktop and mobile UI" { & npm.cmd run verify:terminal-ui-e2e -- --base-url=https://fuman-terminal.vercel.app --only=desktop-night,mobile-phone-portrait-night --routes=strategy3 --route-timeout=120000 --eval-timeout=60000 }
