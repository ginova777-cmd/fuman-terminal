...
const STATIC_ASSETS = [
  "/styles.css?v=public-terminal-fast-20260630-01",
  "/terminal-core.js?v=public-terminal-fast-20260630-01&runtime=desktop-fast-shell-core-20260628-03",
  "/terminal-modules.js?v=public-terminal-fast-20260630-01",
  "/terminal-sector-map.js?v=public-terminal-fast-20260630-01",
  "/terminal-strategy-config.js?v=public-terminal-fast-20260630-01",
  "/terminal-market-config.js?v=public-terminal-fast-20260630-01",
  "/terminal-ui-config.js?v=public-terminal-fast-20260630-01",
  "/terminal-runtime-config.js?v=public-terminal-fast-20260630-01",
  "/terminal-tuning-config.js?v=public-terminal-fast-20260630-01",
  "/terminal-worker.js?v=public-terminal-fast-20260630-01",
  "/terminal.js?v=public-terminal-fast-20260630-01",
  "/terminal-app.js?v=public-terminal-fast-20260630-01",
  "/terminal-ai-risk-guard.js?v=public-terminal-fast-20260630-01",
  ...
  "/terminal-member-module.js?v=public-terminal-fast-20260630-01",
  "/terminal-market-snapshot-module.js?v=public-terminal-fast-20260630-01",
  "/terminal-strategy-module.js?v=public-terminal-fast-20260630-01",
  "/terminal-watchlist-shell.js?v=watchlist-rich-shell-20260628-07",
  "/terminal-watchlist-shell.js?v=public-terminal-fast-20260630-01",
  "/terminal-chip-snapshot-module.js?v=public-terminal-fast-20260630-01",
...
async function purgeOldWatchlistAssets() {
  ...
  await Promise.allSettled(requests.map((request) => {
    const url = new URL(request.url);
    if (url.pathname === "/terminal-watchlist-shell.js" && !url.search.includes(WATCHLIST_SHELL_ASSET_EPOCH) && !url.search.includes("public-terminal-fast-20260630-01")) return cache.delete(request);
