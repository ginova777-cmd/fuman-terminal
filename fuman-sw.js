const CACHE_VERSION = "fuman-terminal-sw-chip-flow-hardening-20260611-07";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=chip-flow-hardening-20260611-07",
  "/terminal-core.js?v=chip-flow-hardening-20260611-07",
  "/terminal-modules.js?v=chip-flow-hardening-20260611-07",
  "/terminal-sector-map.js?v=chip-flow-hardening-20260611-07",
  "/terminal-strategy-config.js?v=chip-flow-hardening-20260611-07",
  "/terminal-market-config.js?v=chip-flow-hardening-20260611-07",
  "/terminal-ui-config.js?v=chip-flow-hardening-20260611-07",
  "/terminal-runtime-config.js?v=chip-flow-hardening-20260611-07",
  "/terminal-tuning-config.js?v=chip-flow-hardening-20260611-07",
  "/terminal-worker.js?v=chip-flow-hardening-20260611-07",
  "/terminal.js?v=chip-flow-hardening-20260611-07",
  "/terminal-app.js?v=chip-flow-hardening-20260611-07",
  "/terminal-chip-flow.js?v=chip-flow-hardening-20260611-07",
  "/terminal-warrant-flow.js?v=chip-flow-hardening-20260611-07",
  "/terminal-watchlist-module.js?v=chip-flow-hardening-20260611-07",
  "/terminal-realtime-radar.css?v=chip-flow-hardening-20260611-07",
  "/terminal-intraday-radar.css?v=chip-flow-hardening-20260611-07",
  "/terminal-utility.css?v=chip-flow-hardening-20260611-07",
  "/refresh.html?v=chip-flow-hardening-20260611-07",
  "/assets/logo.webp",
  "/favicon.ico",
];
