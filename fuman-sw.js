const CACHE_VERSION = "fuman-terminal-sw-chip-flow-hardening-20260611-38";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=chip-flow-hardening-20260611-38",
  "/terminal-core.js?v=chip-flow-hardening-20260611-38",
  "/terminal-modules.js?v=chip-flow-hardening-20260611-38",
  "/terminal-sector-map.js?v=chip-flow-hardening-20260611-38",
  "/terminal-strategy-config.js?v=chip-flow-hardening-20260611-38",
  "/terminal-market-config.js?v=chip-flow-hardening-20260611-38",
  "/terminal-ui-config.js?v=chip-flow-hardening-20260611-38",
  "/terminal-runtime-config.js?v=chip-flow-hardening-20260611-38",
  "/terminal-tuning-config.js?v=chip-flow-hardening-20260611-38",
  "/terminal-worker.js?v=chip-flow-hardening-20260611-38",
  "/terminal.js?v=chip-flow-hardening-20260611-38",
  "/terminal-app.js?v=chip-flow-hardening-20260611-38",
  "/terminal-chip-flow.js?v=chip-flow-hardening-20260611-38",
  "/terminal-warrant-flow.js?v=chip-flow-hardening-20260611-38",
  "/terminal-watchlist-module.js?v=chip-flow-hardening-20260611-38",
  "/terminal-realtime-radar.css?v=chip-flow-hardening-20260611-38",
  "/terminal-intraday-radar.css?v=chip-flow-hardening-20260611-38",
  "/terminal-utility.css?v=chip-flow-hardening-20260611-38",
  "/refresh.html?v=chip-flow-hardening-20260611-38",
  "/assets/logo.webp",
  "/favicon.ico",
];
