const CACHE_VERSION = "fuman-terminal-sw-public-terminal-fast-20260714-24-decision-prices-20260819-01";
...
const STATIC_ASSETS = [
  "/styles.css?v=public-terminal-fast-20260714-24",
  "/terminal-core.js?v=public-terminal-fast-20260714-24&runtime=desktop-fast-shell-core-20260628-03",
  "/terminal-modules.js?v=public-terminal-fast-20260714-24",
  "/terminal-sector-map.js?v=public-terminal-fast-20260714-24",
  "/terminal-strategy-config.js?v=public-terminal-fast-20260714-24",
  "/terminal-market-config.js?v=public-terminal-fast-20260714-24",
  "/terminal-ui-config.js?v=public-terminal-fast-20260714-24",
  "/terminal-runtime-config.js?v=public-terminal-fast-20260714-24",
  "/terminal-tuning-config.js?v=public-terminal-fast-20260714-24",
  "/terminal-worker.js?v=public-terminal-fast-20260714-24",
  "/terminal.js?v=public-terminal-fast-20260714-24",
  "/terminal-desktop-fast-shell.js?buy-sell-derived-fields=20260629-01&strategy2-history=20260629-01&realtime-ledger=20260630-02&heatmap-live-contract=20260630-01&strategy2-card=20260701-03&strategy4-triangle=20260702-02&market-ai-single-renderer=20260702-03&display-switcher=20260702-01&strategy5-live-meta=20260706-02&strategy3-formal-header=20260708-01&market-ai-watchlist-actions=20260709-01&strategy3-card-ui=20260709-04&market-ai-clean-layout=20260713-01&strategy5-confluence-mix=20260715-02&protected-no-stale-first-paint=20260724-01&v=public-terminal-fast-20260714-24&industry-detection-state=20260731-03&strategy4-daily-kline=20260813-01&strategy4-kline-pointer=20260813-01&strategy4-kline-visible=20260813-01&strategy3-strategy4-inline-daily-kline=20260814-01&opening-briefing-clean=20260813-01&strategy2-panel-layout=20260813-07&sunlight-polish=20260813-01&compact-layout=20260813-06&three-gate-prices=20260818-04&sunlight-daily-kline=20260816-03&strategy5-w-neckline-annotation=20260816-27&strategy5-w-bottom-rebound=20260816-01&daily-kline-native-chart=20260816-30&strategy5-terminal-confluence=20260816-01",
  "/terminal-app.js?v=public-terminal-fast-20260714-24",
  "/terminal-entitlement-guard.js?v=public-terminal-fast-20260714-24",
  "/terminal-market-ai-live-watchdog.js?v=public-terminal-fast-20260714-24",
  "/terminal-ai-risk-guard.js?v=public-terminal-fast-20260714-24",
  ...
  "/terminal-member-module.js?v=public-terminal-fast-20260714-24",
  "/terminal-market-snapshot-module.js?v=public-terminal-fast-20260714-24",
  "/terminal-strategy-module.js?v=public-terminal-fast-20260714-24",
  `/terminal-watchlist-shell.js?v=${WATCHLIST_SHELL_ASSET_EPOCH}`,
  "/terminal-chip-snapshot-module.js?v=public-terminal-fast-20260714-24",
  "/terminal-chip-flow.js?v=public-terminal-fast-20260714-24",
  "/terminal-watchlist-module.js?v=public-terminal-fast-20260714-24",
  "/terminal-intraday-radar.css?v=public-terminal-fast-20260714-24",
  "/terminal-utility.css?v=public-terminal-fast-20260714-24",
  "/refresh.html?v=public-terminal-fast-20260714-24",
  "/assets/logo.webp",
  "/favicon.ico",
];
