const CACHE_VERSION = "fuman-terminal-sw-institution-cache-refresh-20260616-01";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=institution-cache-refresh-20260616-01",
  "/terminal-core.js?v=institution-cache-refresh-20260616-01",
  "/terminal-modules.js?v=institution-cache-refresh-20260616-01",
  "/terminal-sector-map.js?v=institution-cache-refresh-20260616-01",
  "/terminal-strategy-config.js?v=institution-cache-refresh-20260616-01",
  "/terminal-market-config.js?v=institution-cache-refresh-20260616-01",
  "/terminal-ui-config.js?v=institution-cache-refresh-20260616-01",
  "/terminal-runtime-config.js?v=institution-cache-refresh-20260616-01",
  "/terminal-tuning-config.js?v=institution-cache-refresh-20260616-01",
  "/terminal-worker.js?v=institution-cache-refresh-20260616-01",
  "/terminal.js?v=institution-cache-refresh-20260616-01",
  "/terminal-app.js?v=institution-cache-refresh-20260616-01",
  "/terminal-ai-risk-guard.js?v=institution-cache-refresh-20260616-01",
  "/terminal-chip-flow.js?v=institution-cache-refresh-20260616-01",
  "/terminal-warrant-flow.js?v=institution-cache-refresh-20260616-01",
  "/terminal-watchlist-module.js?v=institution-cache-refresh-20260616-01",
  "/terminal-realtime-radar.css?v=institution-cache-refresh-20260616-01",
  "/terminal-intraday-radar.css?v=institution-cache-refresh-20260616-01",
  "/terminal-utility.css?v=institution-cache-refresh-20260616-01",
  "/refresh.html?v=institution-cache-refresh-20260616-01",
  "/assets/logo.webp",
  "/favicon.ico",
];
