const CACHE_VERSION = "fuman-terminal-sw-20260530-12";
...
const STATIC_ASSETS = [
  ...
  "/terminal-core.js?v=speed-modules-20260530-12",
  "/terminal-modules.js?v=speed-modules-20260530-12",
  "/terminal-sector-map.js?v=speed-modules-20260530-12",
  "/terminal-strategy-config.js?v=speed-modules-20260530-12",
  "/terminal-market-config.js?v=speed-modules-20260530-12",
  "/terminal-worker.js?v=speed-modules-20260530-12",
  "/terminal.js?v=speed-modules-20260530-12",
  "/assets/logo.png",
  "/favicon.ico",
];
