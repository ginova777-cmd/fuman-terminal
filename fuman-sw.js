const CACHE_VERSION = "fuman-terminal-sw-strategy5-oldk-restore-20260616";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=strategy5-oldk-restore-20260616",
  "/terminal-core.js?v=strategy5-oldk-restore-20260616",
  "/terminal-modules.js?v=strategy5-oldk-restore-20260616",
  "/terminal-sector-map.js?v=strategy5-oldk-restore-20260616",
  "/terminal-strategy-config.js?v=strategy5-oldk-restore-20260616",
  "/terminal-market-config.js?v=strategy5-oldk-restore-20260616",
  "/terminal-ui-config.js?v=strategy5-oldk-restore-20260616",
  "/terminal-runtime-config.js?v=strategy5-oldk-restore-20260616",
  "/terminal-tuning-config.js?v=strategy5-oldk-restore-20260616",
  "/terminal-worker.js?v=strategy5-oldk-restore-20260616",
  "/terminal.js?v=strategy5-oldk-restore-20260616",
  "/terminal-app.js?v=strategy5-oldk-restore-20260616",
  "/terminal-chip-flow.js?v=strategy5-oldk-restore-20260616",
  "/terminal-warrant-flow.js?v=strategy5-oldk-restore-20260616",
  "/terminal-watchlist-module.js?v=strategy5-oldk-restore-20260616",
  "/terminal-realtime-radar.css?v=strategy5-oldk-restore-20260616",
  "/terminal-intraday-radar.css?v=strategy5-oldk-restore-20260616",
  "/terminal-utility.css?v=strategy5-oldk-restore-20260616",
  "/refresh.html?v=strategy5-oldk-restore-20260616",
  "/assets/logo.webp",
  "/favicon.ico",
];
