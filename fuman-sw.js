const CACHE_VERSION = "fuman-terminal-sw-20260607-watchlist-detail-clean";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=watchlist-detail-clean-20260607",
  "/terminal-core.js?v=watchlist-detail-clean-20260607",
  "/terminal-modules.js?v=watchlist-detail-clean-20260607",
  "/terminal-sector-map.js?v=watchlist-detail-clean-20260607",
  "/terminal-strategy-config.js?v=watchlist-detail-clean-20260607",
  "/terminal-market-config.js?v=watchlist-detail-clean-20260607",
  "/terminal-ui-config.js?v=watchlist-detail-clean-20260607",
  "/terminal-runtime-config.js?v=watchlist-detail-clean-20260607",
  "/terminal-tuning-config.js?v=watchlist-detail-clean-20260607",
  "/terminal-worker.js?v=watchlist-detail-clean-20260607",
  "/terminal.js?v=watchlist-detail-clean-20260607",
  "/terminal-realtime-radar.css?v=watchlist-detail-clean-20260607",
  "/terminal-intraday-radar.css?v=watchlist-detail-clean-20260607",
  "/terminal-utility.css?v=watchlist-detail-clean-20260607",
  "/refresh.html?v=watchlist-detail-clean-20260607",
  "/assets/logo.webp",
  "/favicon.ico",
];
