const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-all-20260618-17";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-all-20260618-17",
  "/terminal-core.js?v=desktop-api-only-all-20260618-17",
  "/terminal-modules.js?v=desktop-api-only-all-20260618-17",
  "/terminal-sector-map.js?v=desktop-api-only-all-20260618-17",
  "/terminal-strategy-config.js?v=desktop-api-only-all-20260618-17",
  "/terminal-market-config.js?v=desktop-api-only-all-20260618-17",
  "/terminal-ui-config.js?v=desktop-api-only-all-20260618-17",
  "/terminal-runtime-config.js?v=desktop-api-only-all-20260618-17",
  "/terminal-tuning-config.js?v=desktop-api-only-all-20260618-17",
  "/terminal-worker.js?v=desktop-api-only-all-20260618-17",
  "/terminal.js?v=desktop-api-only-all-20260618-17",
  "/terminal-app.js?v=desktop-api-only-all-20260618-17",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-all-20260618-17",
  "/terminal-chip-flow.js?v=desktop-api-only-all-20260618-17",
  "/terminal-warrant-flow.js?v=desktop-api-only-all-20260618-17",
  "/terminal-watchlist-module.js?v=desktop-api-only-all-20260618-17",
  "/terminal-realtime-radar.css?v=desktop-api-only-all-20260618-17",
  "/terminal-intraday-radar.css?v=desktop-api-only-all-20260618-17",
  "/terminal-utility.css?v=desktop-api-only-all-20260618-17",
  "/refresh.html?v=desktop-api-only-all-20260618-17",
  "/assets/logo.webp",
  "/favicon.ico",
];
