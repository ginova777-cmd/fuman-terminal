const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-strategy5-fasttabs-20260619-03";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-core.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-modules.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-sector-map.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-strategy-config.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-market-config.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-ui-config.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-runtime-config.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-tuning-config.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-worker.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-app.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-chip-flow.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-warrant-flow.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-watchlist-module.js?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-realtime-radar.css?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-intraday-radar.css?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/terminal-utility.css?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/refresh.html?v=desktop-api-only-strategy5-fasttabs-20260619-03",
  "/assets/logo.webp",
  "/favicon.ico",
];
