const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-strategy5-volume-units-20260619-07";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-core.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-modules.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-sector-map.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-strategy-config.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-market-config.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-ui-config.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-runtime-config.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-tuning-config.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-worker.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-app.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-chip-flow.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-warrant-flow.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-watchlist-module.js?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-realtime-radar.css?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-intraday-radar.css?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/terminal-utility.css?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/refresh.html?v=desktop-api-only-strategy5-volume-units-20260619-07",
  "/assets/logo.webp",
  "/favicon.ico",
];
