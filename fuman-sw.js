const CACHE_VERSION = "fuman-terminal-sw-public-terminal-fast-20260630-14";
...
const STATIC_ASSETS = [
  "/styles.css?v=public-terminal-fast-20260630-14",
  "/terminal-core.js?v=public-terminal-fast-20260630-14&runtime=desktop-fast-shell-core-20260628-03",
  "/terminal-modules.js?v=public-terminal-fast-20260630-14",
  "/terminal-sector-map.js?v=public-terminal-fast-20260630-14",
  "/terminal-strategy-config.js?v=public-terminal-fast-20260630-14",
  "/terminal-market-config.js?v=public-terminal-fast-20260630-14",
  "/terminal-ui-config.js?v=public-terminal-fast-20260630-14",
  "/terminal-runtime-config.js?v=public-terminal-fast-20260630-14",
  "/terminal-tuning-config.js?v=public-terminal-fast-20260630-14",
  "/terminal-worker.js?v=public-terminal-fast-20260630-14",
  "/terminal.js?v=public-terminal-fast-20260630-14",
  "/terminal-app.js?v=public-terminal-fast-20260630-14",
  "/terminal-market-ai-live-watchdog.js?v=public-terminal-fast-20260630-14",
  "/terminal-ai-risk-guard.js?v=public-terminal-fast-20260630-14",
  ...
  "/terminal-member-module.js?v=public-terminal-fast-20260630-14",
  "/terminal-market-snapshot-module.js?v=public-terminal-fast-20260630-14",
  "/terminal-strategy-module.js?v=public-terminal-fast-20260630-14",
  "/terminal-watchlist-shell.js?v=watchlist-rich-shell-20260628-07",
  "/terminal-realtime-radar.css?v=radar-ledger-20260630-02",
  "/terminal-watchlist-shell.js?v=public-terminal-fast-20260630-14",
  "/terminal-chip-snapshot-module.js?v=public-terminal-fast-20260630-14",
  "/terminal-chip-flow.js?v=public-terminal-fast-20260630-14",
  "/terminal-warrant-flow.js?v=public-terminal-fast-20260630-14",
  "/terminal-watchlist-module.js?v=public-terminal-fast-20260630-14",
  "/terminal-intraday-radar.css?v=public-terminal-fast-20260630-14",
  "/terminal-utility.css?v=public-terminal-fast-20260630-14",
  "/refresh.html?v=public-terminal-fast-20260630-14",
  "/assets/logo.webp",
  "/favicon.ico",
];
...
async function purgeOldWatchlistAssets() {
  ...
  await Promise.allSettled(requests.map((request) => {
    const url = new URL(request.url);
    if (url.pathname === "/terminal-watchlist-shell.js" && !url.search.includes(WATCHLIST_SHELL_ASSET_EPOCH) && !url.search.includes("public-terminal-fast-20260630-14")) return cache.delete(request);
