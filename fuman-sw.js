const CACHE_VERSION = "fuman-terminal-sw-chip-flow-hardening-20260611-04";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=chip-flow-hardening-20260611-04",
  "/terminal-core.js?v=chip-flow-hardening-20260611-04",
  "/terminal-modules.js?v=chip-flow-hardening-20260611-04",
  "/terminal-sector-map.js?v=chip-flow-hardening-20260611-04",
  "/terminal-strategy-config.js?v=chip-flow-hardening-20260611-04",
  "/terminal-market-config.js?v=chip-flow-hardening-20260611-04",
  "/terminal-ui-config.js?v=chip-flow-hardening-20260611-04",
  "/terminal-runtime-config.js?v=chip-flow-hardening-20260611-04",
  "/terminal-tuning-config.js?v=chip-flow-hardening-20260611-04",
  "/terminal-worker.js?v=chip-flow-hardening-20260611-04",
  "/terminal.js?v=chip-flow-hardening-20260611-04",
  "/terminal-app.js?v=chip-flow-hardening-20260611-04",
  "/terminal-chip-flow.js?v=chip-flow-hardening-20260611-04",
  "/terminal-warrant-flow.js?v=chip-flow-hardening-20260611-04",
  "/terminal-watchlist-module.js?v=chip-flow-hardening-20260611-04",
  "/terminal-realtime-radar.css?v=chip-flow-hardening-20260611-04",
  "/terminal-intraday-radar.css?v=chip-flow-hardening-20260611-04",
  "/terminal-utility.css?v=chip-flow-hardening-20260611-04",
  "/refresh.html?v=chip-flow-hardening-20260611-04",
  "/assets/logo.webp",
  "/favicon.ico",
];
