const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-strategy5-fullscan-20260619-06";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-core.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-modules.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-sector-map.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-strategy-config.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-market-config.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-ui-config.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-runtime-config.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-tuning-config.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-worker.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-app.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-chip-flow.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-warrant-flow.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-watchlist-module.js?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-realtime-radar.css?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-intraday-radar.css?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/terminal-utility.css?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/refresh.html?v=desktop-api-only-strategy5-fullscan-20260619-06",
  "/assets/logo.webp",
  "/favicon.ico",
];
