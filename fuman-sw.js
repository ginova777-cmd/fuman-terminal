const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-strategy5-singlepane-20260619-04";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-core.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-modules.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-sector-map.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-strategy-config.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-market-config.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-ui-config.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-runtime-config.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-tuning-config.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-worker.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-app.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-chip-flow.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-warrant-flow.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-watchlist-module.js?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-realtime-radar.css?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-intraday-radar.css?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/terminal-utility.css?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/refresh.html?v=desktop-api-only-strategy5-singlepane-20260619-04",
  "/assets/logo.webp",
  "/favicon.ico",
];
