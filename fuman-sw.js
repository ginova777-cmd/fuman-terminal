const CACHE_VERSION = "fuman-terminal-sw-public-terminal-fast-20260630-07";
...
const STATIC_ASSETS = [
  "/styles.css?v=public-terminal-fast-20260630-07",
  "/terminal-core.js?v=public-terminal-fast-20260630-07&runtime=desktop-fast-shell-core-20260628-03",
  "/terminal-modules.js?v=public-terminal-fast-20260630-07",
  "/terminal-sector-map.js?v=public-terminal-fast-20260630-07",
  "/terminal-strategy-config.js?v=public-terminal-fast-20260630-07",
  "/terminal-market-config.js?v=public-terminal-fast-20260630-07",
  "/terminal-ui-config.js?v=public-terminal-fast-20260630-07",
  "/terminal-runtime-config.js?v=public-terminal-fast-20260630-07",
  "/terminal-tuning-config.js?v=public-terminal-fast-20260630-07",
  "/terminal-worker.js?v=public-terminal-fast-20260630-07",
  "/terminal.js?v=public-terminal-fast-20260630-07",
  "/terminal-app.js?v=public-terminal-fast-20260630-07",
  "/terminal-market-ai-live-watchdog.js?v=public-terminal-fast-20260630-07",
  "/terminal-ai-risk-guard.js?v=public-terminal-fast-20260630-07",
  ...
  "/terminal-member-module.js?v=public-terminal-fast-20260630-07",
  "/terminal-market-snapshot-module.js?v=public-terminal-fast-20260630-07",
  "/terminal-strategy-module.js?v=public-terminal-fast-20260630-07",
  "/terminal-watchlist-shell.js?v=watchlist-rich-shell-20260628-07",
  "/terminal-realtime-radar.css?v=radar-ledger-20260630-02",
  "/terminal-watchlist-shell.js?v=public-terminal-fast-20260630-07",
  "/terminal-chip-snapshot-module.js?v=public-terminal-fast-20260630-07",
  "/terminal-chip-flow.js?v=public-terminal-fast-20260630-07",
  "/terminal-warrant-flow.js?v=public-terminal-fast-20260630-07",
  "/terminal-watchlist-module.js?v=public-terminal-fast-20260630-07",
  "/terminal-intraday-radar.css?v=public-terminal-fast-20260630-07",
  "/terminal-utility.css?v=public-terminal-fast-20260630-07",
  "/refresh.html?v=public-terminal-fast-20260630-07",
  "/assets/logo.webp",
  "/favicon.ico",
];
...
async function purgeOldWatchlistAssets() {
  ...
  await Promise.allSettled(requests.map((request) => {
    const url = new URL(request.url);
    if (url.pathname === "/terminal-watchlist-shell.js" && !url.search.includes(WATCHLIST_SHELL_ASSET_EPOCH) && !url.search.includes("public-terminal-fast-20260630-07")) return cache.delete(request);
