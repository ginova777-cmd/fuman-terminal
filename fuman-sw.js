const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-all-20260618-18";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-all-20260618-18",
  "/terminal-core.js?v=desktop-api-only-all-20260618-18",
  "/terminal-modules.js?v=desktop-api-only-all-20260618-18",
  "/terminal-sector-map.js?v=desktop-api-only-all-20260618-18",
  "/terminal-strategy-config.js?v=desktop-api-only-all-20260618-18",
  "/terminal-market-config.js?v=desktop-api-only-all-20260618-18",
  "/terminal-ui-config.js?v=desktop-api-only-all-20260618-18",
  "/terminal-runtime-config.js?v=desktop-api-only-all-20260618-18",
  "/terminal-tuning-config.js?v=desktop-api-only-all-20260618-18",
  "/terminal-worker.js?v=desktop-api-only-all-20260618-18",
  "/terminal.js?v=desktop-api-only-all-20260618-18",
  "/terminal-app.js?v=desktop-api-only-all-20260618-18",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-all-20260618-18",
  "/terminal-chip-flow.js?v=desktop-api-only-all-20260618-18",
  "/terminal-warrant-flow.js?v=desktop-api-only-all-20260618-18",
  "/terminal-watchlist-module.js?v=desktop-api-only-all-20260618-18",
  "/terminal-realtime-radar.css?v=desktop-api-only-all-20260618-18",
  "/terminal-intraday-radar.css?v=desktop-api-only-all-20260618-18",
  "/terminal-utility.css?v=desktop-api-only-all-20260618-18",
  "/refresh.html?v=desktop-api-only-all-20260618-18",
  "/assets/logo.webp",
  "/favicon.ico",
];
