const CACHE_VERSION = "fuman-terminal-sw-desktop-api-only-strategy5-institution-streak-20260619-10";
const RUNTIME_THEME_CSS_LOADER = "terminal-theme-css-snapshot-first-20260619";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-core.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-modules.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-sector-map.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-strategy-config.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-market-config.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-ui-config.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-runtime-config.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-tuning-config.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-worker.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-app.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-ai-risk-guard.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-chip-flow.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-warrant-flow.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-watchlist-module.js?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-realtime-radar.css?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-intraday-radar.css?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/terminal-utility.css?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/refresh.html?v=desktop-api-only-strategy5-institution-streak-20260619-10",
  "/assets/logo.webp",
  "/favicon.ico",
];
