const CACHE_VERSION = "fuman-terminal-sw-strategy4-cache-20260611-02";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=strategy4-cache-20260611-02",
  "/terminal-core.js?v=strategy4-cache-20260611-02",
  "/terminal-modules.js?v=strategy4-cache-20260611-02",
  "/terminal-sector-map.js?v=strategy4-cache-20260611-02",
  "/terminal-strategy-config.js?v=strategy4-cache-20260611-02",
  "/terminal-market-config.js?v=strategy4-cache-20260611-02",
  "/terminal-ui-config.js?v=strategy4-cache-20260611-02",
  "/terminal-runtime-config.js?v=strategy4-cache-20260611-02",
  "/terminal-tuning-config.js?v=strategy4-cache-20260611-02",
  "/terminal-worker.js?v=strategy4-cache-20260611-02",
  "/terminal.js?v=strategy4-cache-20260611-02",
  "/terminal-app.js?v=strategy4-cache-20260611-02",
  "/terminal-chip-flow.js?v=strategy4-cache-20260611-02",
  "/terminal-warrant-flow.js?v=strategy4-cache-20260611-02",
  "/terminal-watchlist-module.js?v=strategy4-cache-20260611-02",
  "/terminal-realtime-radar.css?v=strategy4-cache-20260611-02",
  "/terminal-intraday-radar.css?v=strategy4-cache-20260611-02",
  "/terminal-utility.css?v=strategy4-cache-20260611-02",
  "/refresh.html?v=strategy4-cache-20260611-02",
  "/assets/logo.webp",
  "/favicon.ico",
];
