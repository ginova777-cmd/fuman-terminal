const CACHE_VERSION = "fuman-terminal-sw-chip-flow-hardening-20260611-25";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=chip-flow-hardening-20260611-25",
  "/terminal-core.js?v=chip-flow-hardening-20260611-25",
  "/terminal-modules.js?v=chip-flow-hardening-20260611-25",
  "/terminal-sector-map.js?v=chip-flow-hardening-20260611-25",
  "/terminal-strategy-config.js?v=chip-flow-hardening-20260611-25",
  "/terminal-market-config.js?v=chip-flow-hardening-20260611-25",
  "/terminal-ui-config.js?v=chip-flow-hardening-20260611-25",
  "/terminal-runtime-config.js?v=chip-flow-hardening-20260611-25",
  "/terminal-tuning-config.js?v=chip-flow-hardening-20260611-25",
  "/terminal-worker.js?v=chip-flow-hardening-20260611-25",
  "/terminal.js?v=chip-flow-hardening-20260611-25",
  "/terminal-app.js?v=chip-flow-hardening-20260611-25",
  "/terminal-chip-flow.js?v=chip-flow-hardening-20260611-25",
  "/terminal-warrant-flow.js?v=chip-flow-hardening-20260611-25",
  "/terminal-watchlist-module.js?v=chip-flow-hardening-20260611-25",
  "/terminal-realtime-radar.css?v=chip-flow-hardening-20260611-25",
  "/terminal-intraday-radar.css?v=chip-flow-hardening-20260611-25",
  "/terminal-utility.css?v=chip-flow-hardening-20260611-25",
  "/refresh.html?v=chip-flow-hardening-20260611-25",
  "/assets/logo.webp",
  "/favicon.ico",
];
