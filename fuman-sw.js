const CACHE_VERSION = "fuman-terminal-sw-20260602-mobile-title-card-fixed";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=mobile-title-card-fixed-20260602",
  "/terminal-core.js?v=mobile-title-card-fixed-20260602",
  "/terminal-modules.js?v=mobile-title-card-fixed-20260602",
  "/terminal-sector-map.js?v=mobile-title-card-fixed-20260602",
  "/terminal-strategy-config.js?v=mobile-title-card-fixed-20260602",
  "/terminal-market-config.js?v=mobile-title-card-fixed-20260602",
  "/terminal-ui-config.js?v=mobile-title-card-fixed-20260602",
  "/terminal-runtime-config.js?v=mobile-title-card-fixed-20260602",
  "/terminal-tuning-config.js?v=mobile-title-card-fixed-20260602",
  "/terminal-worker.js?v=mobile-title-card-fixed-20260602",
  "/terminal.js?v=mobile-title-card-fixed-20260602",
