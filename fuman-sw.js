...
const STATIC_ASSETS = [
  "/styles.css?v=chip-flow-hardening-20260611-21",
  "/terminal-core.js?v=chip-flow-hardening-20260611-21",
  "/terminal-modules.js?v=chip-flow-hardening-20260611-21",
  "/terminal-sector-map.js?v=chip-flow-hardening-20260611-21",
  "/terminal-strategy-config.js?v=chip-flow-hardening-20260611-21",
  "/terminal-market-config.js?v=chip-flow-hardening-20260611-21",
  "/terminal-ui-config.js?v=chip-flow-hardening-20260611-21",
  "/terminal-runtime-config.js?v=chip-flow-hardening-20260611-21",
  "/terminal-tuning-config.js?v=chip-flow-hardening-20260611-21",
  "/terminal-worker.js?v=chip-flow-hardening-20260611-21",
  "/terminal.js?v=chip-flow-hardening-20260611-21",
  "/terminal-app.js?v=chip-flow-hardening-20260611-21",
  "/terminal-chip-flow.js?v=chip-flow-hardening-20260611-21",
  "/terminal-warrant-flow.js?v=chip-flow-hardening-20260611-21",
  "/terminal-watchlist-module.js?v=chip-flow-hardening-20260611-21",
  "/terminal-realtime-radar.css?v=chip-flow-hardening-20260611-21",
  "/terminal-intraday-radar.css?v=chip-flow-hardening-20260611-21",
  "/terminal-utility.css?v=chip-flow-hardening-20260611-21",
  "/refresh.html?v=chip-flow-hardening-20260611-21",
  "/assets/logo.webp",
  "/favicon.ico",
];
