const CACHE_VERSION = "fuman-terminal-sw-chip-flow-cache-20260611-01";
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;

const STATIC_ASSETS = [
  "/styles.css?v=chip-flow-cache-20260611-01",
  "/terminal-core.js?v=chip-flow-cache-20260611-01",
  "/terminal-modules.js?v=chip-flow-cache-20260611-01",
  "/terminal-sector-map.js?v=chip-flow-cache-20260611-01",
  "/terminal-strategy-config.js?v=chip-flow-cache-20260611-01",
  "/terminal-market-config.js?v=chip-flow-cache-20260611-01",
  "/terminal-ui-config.js?v=chip-flow-cache-20260611-01",
  "/terminal-runtime-config.js?v=chip-flow-cache-20260611-01",
  "/terminal-tuning-config.js?v=chip-flow-cache-20260611-01",
  "/terminal-worker.js?v=chip-flow-cache-20260611-01",
  "/terminal.js?v=chip-flow-cache-20260611-01",
  "/terminal-app.js?v=chip-flow-cache-20260611-01",
  "/terminal-chip-flow.js?v=chip-flow-cache-20260611-01",
  "/terminal-warrant-flow.js?v=chip-flow-cache-20260611-01",
  "/terminal-watchlist-module.js?v=chip-flow-cache-20260611-01",
  "/terminal-realtime-radar.css?v=chip-flow-cache-20260611-01",
  "/terminal-intraday-radar.css?v=chip-flow-cache-20260611-01",
  "/terminal-utility.css?v=chip-flow-cache-20260611-01",
  "/refresh.html?v=chip-flow-cache-20260611-01",
  "/assets/logo.webp",
  "/favicon.ico",
];
